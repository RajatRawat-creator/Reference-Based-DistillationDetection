...
# OMI-CoT few-shot candidate map: the four teachers' s1 responses generated
# with the target student's own in-context exemplars ("+ In-context exemplars
# from S"). --datasets_dir is the per-student subfolder under
# data/omi_cot_fewshot/. Keys match the original Reference_Fewshot result JSONs.
FILES_MAP = {
    "Nvidia-Llama-3.3-70B-Instruct (s1, Chat)": "nvidia__Llama-3.3-70B-Instruct-FP8__s1k__fewshot__vllm.jsonl",
    "GPT-OSS-120B (s1, Chat)": "openai__gpt-oss-120b__s1k__fewshot__vllm.jsonl",
    "Qwen-3-8B (s1, Chat)": "Qwen__Qwen3-8B__s1k__fewshot__vllm.jsonl",
    "Gemma-3-27B-it (s1, Chat)": "google__gemma-3-27b-it__s1k__fewshot__vllm.jsonl",
}
